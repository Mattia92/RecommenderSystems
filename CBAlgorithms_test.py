...
def InitializeDictionaries_item(item_profile, item_cols):
    ...
    # Create the dictionary containing for each attribute the list of users which have it
    # Dictionary is a list of elements, each element is defined as following
    # dict {attribute -> (list of {item -> value})}
...
def CBSIM(user_attributes_dictionary, attributes_users_dictionary, similarity_shrink, KNN, target_users):
...
def CBUserUserSimilarity(user_attributes_dictionary, attributes_users_dictionary, interacted_users_dictionary, similarity_shrink,
                         KNN, target_users):
