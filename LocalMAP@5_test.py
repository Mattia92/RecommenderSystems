...
import pandas as pd
import CFAlgorithms
import CBAlgorithms_test as CBAlgorithms
...
item_cols.remove('created_at')
item_cols.remove('active_during_test')
...
CB_user_user_similarity_dictionary = CBAlgorithms.CBSIM(CB_user_attributes_dictionary, CB_attribute_users_dictionary,
                                                                       CB_UB_similarity_shrink, CB_UB_KNN, target_users)
