...
CB_item_attributes_dictionary = CBAlgorithms.CB_IB_ComputeTF_IDF(CB_item_attributes_dictionary, CB_attribute_items_dictionary)

CB_item_attributes_dictionary, CB_attribute_items_dictionary, CB_target_item_attributes_dictionary = CBAlgorithms.Cut_Dict_Items_Attributes(CB_item_attributes_dictionary,
...
CB_item_item_similarity_dictionary = CBAlgorithms.CBItemItemSimilarity(CB_item_attributes_dictionary, CB_attribute_items_dictionary)
del CB_attribute_items_dictionary

CB_item_item_similarity_dictionary = CBAlgorithms.CBItemItemSimilarityEstimate(CB_item_item_similarity_dictionary, CB_item_attributes_dictionary, CB_target_item_attributes_dictionary,
