...
#CFAlgorithms.CFWriteResult(CF_HB_UB_Output, CF_HB_UB_users_prediction_dictionary)
...
#CFAlgorithms.CFWriteResult(CF_HB_IB_Output, CF_HB_IB_users_prediction_dictionary)
