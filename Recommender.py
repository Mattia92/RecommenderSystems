...
CF_HB_UB_Output = "Results/CF_Hybrid_User_Based.csv"
CF_IB_Output = "Results/CF_Item_Based.csv"
CF_HB_IB_Output = "Results/CF_Hybrid_Item_Based.csv"
...
#CFAlgorithms.CFWriteResult(CF_HB_UB_MAP_Output, CF_HB_UB_users_prediction_dictionary)
...
CFAlgorithms.CFWriteResult(CF_Hybrid_Ranked_Output, CF_CB_HB_Ranked_users_prediction_dictionary)